...
You can bypass those if you receive a **license agreement** from the owner of the patent, this is the authorization.

We say that the patent owner has the *exclusive right*, meaning the right we mentioned above.
...
### Exclusive Rights and other Technicalities of Patents

Having the exclusive rights to an invention does **not mean** we have the right to **use** it, the use of a patented invention may require permissions from public authorities (safety risks).
...
Patents are also considered to be **commercial tools**, meaning we can do:
- @ Commercialization and exploitation
- @ Licensing and cross-selling
- @ Blocking patents
- @ Out of courts settlements - including licensing or cross-licensing - may be viable alternative to patent litigation for both parties
- @ Reputation building
- ...
- ! However, often **patents are not used at all**, they just exist to protect our work

***

## Patents - Remedies

**Remedy** in legal terms is basically the *fix* or *compensation* provided by a court to a patent owner whose rights have been violated. It's how we're compensated when we've proven that there was a patent **infringement**.

The remedies one usually gets are the following:
