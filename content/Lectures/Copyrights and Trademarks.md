...
>[!danger] Note
Again, I'm just mostly gonna put the important slides here and a few words, maybe some explanations in between, most of the stuff just is on the slides
...
>- Movies, recordings
>- Architecture
>- *Computer Programs* (Both the source code and the binary code are protected.)
>
>Then there are cases that are less clear, for example ***databases***, the idea here is that even though the database doesn't really have **creativity**, since you're aggregating data that already exists, the **effort** of bringing that data together grants you some sort of right (**not true copyright**) on the database, to disable others from just stealing your hard work.
>
>>[!note] Note
...
>
>
>There are also *neighboring rights* that protect the rights of:
>- Performers
...
>- Photographers
>
>But the existence and the scope of those rights differ **across countries**.

***

## Copyrights - Procedure

>[!note] General notes on Copyright
>**Copyright** is *automatically granted at the moment of creation*, you **don't need** a copyright notice © nor a registration, which is a big difference to *patent law*.
>
...
## Trademarks - Legal requirements

>[!note] Conventional and unconventional trademarks
>Trademarks conventionally are about:
>- Words, letters, numerals and slogans
>- Figurative elements, **logos**
>- 3D shapes
>- Color patterns
>
>There are also some more unconventional ones:
...
### Other requirements for trademark protection

It needs to have **no absolute grounds for refusal** (based on Art. 4 of the EU Trademark Directive)
In this we distinguish between:

1. @ Absolute grounds: general requirements for a sign to be a suitable trademark, those are the **general requirements** for trademarks which we'll see below
2. @ Relative grounds: trademark registration may be denied based on comparison with prior rights
	1. ? Note that **EUIPO** does not refuse applications because of relative grounds
	2. Third parties can bring up relative grounds in opposition or cancellation proceedings

#### Absolute grounds 

>[!note] Absolute grounds
>Here's a list of grounds for refusal according to the **absolute grounds**:
>1. No **distinctive** character
>	1. @ This may change over time since it depends on what exists at the moment of application
...
>
>The trademarks are generally also registered for a specific product range, this means that you could have the same trademarks from different companies if their product is **different enough in the market**, meaning that they are not in the same *category* of products so to speak.
>
>Registration is possible at $3$ levels:
>1. National
>2. Regional
>3. International
>
>These registrations can **coexist**, meaning you can have the same trademark in two different *nations or regions, or in the same nation but for different markets*
>
>>[!tip] Tip 
>>The general idea with trademarks is that it's first-come-first-served, so always register your trademarks early
...
>[!danger] Causes for cancellation
>- Invalidity
>- Revocation:
>	- Lack of genuine use
>	- Acquired generic character (it became a part of society in between, can't be a trademark anymore)
>	- Misuse
...
Only a few slides on that, nothing much to write about, slides are good though.
